...
// Query: *[    _type == "recipe"    && defined(slug.current)    && (      !defined($siteCode)      || $siteCode != "LFD"      || "LFD" in coalesce(versions, [])    )  ] | order(name asc).slug.current
