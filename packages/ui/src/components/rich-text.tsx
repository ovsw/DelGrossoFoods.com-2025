...
import type { SanityImageComponent, SanityImageSource } from "./sanity-image";

type ParseChildrenToSlug = (
  children: PortableTextBlock["children"],
) => string | undefined;

type CreateRichTextOptions<TImage extends SanityImageSource> = {
  SanityImage: SanityImageComponent<TImage>;
  parseChildrenToSlug: ParseChildrenToSlug;
};

export function createRichText<TImage extends SanityImageSource>({
  SanityImage,
  parseChildrenToSlug,
}: CreateRichTextOptions<TImage>) {
