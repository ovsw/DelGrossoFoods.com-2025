...
import type { DgfHistoryPageQueryResult } from "@workspace/sanity-config/types";
...
import { dgfHistoryPageQuery } from "@/lib/sanity/queries";
import { getSEOMetadata } from "@/lib/seo";

export async function generateMetadata(): Promise<Metadata> {
  const historyData = await sanityFetch({
    query: dgfHistoryPageQuery,
    params: getSiteParams(),
  });

  const data = (historyData?.data ?? null) as DgfHistoryPageQueryResult | null;
