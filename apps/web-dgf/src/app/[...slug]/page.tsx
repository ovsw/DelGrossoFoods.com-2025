...
import { dgfSlugPagePathsQuery, dgfSlugPageQuery } from "@/lib/sanity/queries";
import { getSEOMetadata } from "@/lib/seo";

async function fetchSlugPageData(slug: string, stega = true) {
  return await sanityFetch({
    query: dgfSlugPageQuery,
...
async function fetchSlugPagePaths() {
  const slugs = await client.fetch(dgfSlugPagePathsQuery, getSiteParams());
