...
import type { DgfSettingsQueryResult } from "@workspace/sanity-config/types";
...
import { dgfSettingsQuery } from "@/lib/sanity/queries";
...
interface OrganizationJsonLdProps {
  settings: DgfSettingsQueryResult;
}
...
export async function CombinedJsonLd({
  ...
  const [res] = await handleErrors(
    client.fetch(dgfSettingsQuery, getSiteParams()),
  );
