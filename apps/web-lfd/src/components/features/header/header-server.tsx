...
import type { LfdNavbarQueryResult } from "@workspace/sanity-config/types";

import { createPresentationDataAttribute } from "@/lib/sanity/presentation";
import { lfdNavbarQuery } from "@/lib/sanity/queries";
...
type NavbarData = NonNullable<LfdNavbarQueryResult>;
...
function extractNavbarLinks(
  navbarData: LfdNavbarQueryResult | null | undefined,
): HeaderLink[] {
