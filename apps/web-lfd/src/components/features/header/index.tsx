  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="nav_layout flex h-16 items-center justify-between gap-x-2 rounded-sm border border-brand-yellow/60 bg-black px-4 sm:gap-x-4 sm:px-6 lg:px-8">
            {/* Logo */}
