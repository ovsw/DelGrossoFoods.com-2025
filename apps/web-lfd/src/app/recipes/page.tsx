...
async function fetchIndexCopy() {
  return await handleErrors(
    sanityFetch({ query: lfdRecipeIndexPageQuery, params: getSiteParams() }),
  );
}
async function fetchCategories() {
  return await handleErrors(
    sanityFetch({ query: lfdRecipeCategoriesQuery, params: getSiteParams() }),
  );
}
