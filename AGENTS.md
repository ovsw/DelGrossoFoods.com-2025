...
# SUPER IMPORTANT RULE 0: Future Codex, under no circumstances may you stage (`git add`) or commit, unless the user explicitly asks you to; doing so ends the mission. Stay hands-off Git forever.
